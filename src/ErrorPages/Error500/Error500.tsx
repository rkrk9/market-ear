  ...
  <div>
	...
	<div className="page relative" onClick={() => { switcherIconReomve() }}>
		...
		<div className="container">
			<Row>
				<Col md={7} className="mx-auto d-block">
					<Card className=" p-7 mb-0 mt-7 mt-md-0">
						<div className="text-center">
							<div className="fs-100  mb-5 text-primary font-weight-normal h1"><i className="fa fa-frown-o"></i>ops!</div>
							<h1 className="h3  mb-3 font-weight-bold">Error 501: Internal Server Error</h1>
							<p className="h5 font-weight-normal mb-7 leading-normal">You may have mistyped the address or the page may have moved.</p>
							<Link className="btn btn-primary" to={`/dashboard/dashboard01`}><i className="fe fe-arrow-left-circle m-1"></i>Back to Home</Link>
						</div>
					</Card>
				</Col>
			</Row>
