...
import login from "../../../../assets/images/pattern/login.png";
import { CardBody,Card, Col, Row, Input } from 'reactstrap';
  ...
  <div>
  	<div className="page">
		<div className="page-single p-5">
            ...
            <Row className=" justify-content-center" onClick={() => { switcherIconReomve() }}>
                <Col lg={9} xl={8}>
                    <div className="card-group mb-0">
                        <Card className=" p-4 page-content mt-0">
                            <CardBody className=" page-single-content">
                                <div className="w-100">
                                    <div className="text-center mb-4 ">
                                        <span className="avatar avatar-xxl  brround" style={{backgroundImage: `url(${user16})`}}></span>
                                    </div>
                                    <span className="m-4 d-none d-lg-block text-center">
                                        <span className=""><strong>John Thomson</strong></span>
                                    </span>
                                    <div className="mb-3">
                                        <Input type="password" className="form-control" id="exampleInputPassword1" placeholder="Password"/>
                                    </div>
                                    <Link href={`/dashboard/dashboard01`} className="btn btn-primary btn-block"><i className="fe fe-arrow-right"></i> Unlock</Link>
                                </div>
                            </CardBody>
                        </Card>
...
LockScreen03.propTypes = {};

LockScreen03.defaultProps = {};
