                    ...
                    <Row className=" justify-content-center mt-7 mt-sm-0" onClick={() => { switcherIconReomve() }}>
                        <Col lg={9} xxl={8}>
                                        ...
                                        <div className="w-100">
                                            ...
                                            <Row className="row">
                                                <Col className="col-12">
                                                    <Link role="button" to={`/dashboard/dashboard01`} className="btn btn-lg btn-primary btn-block"><i className="fe fe-arrow-right"></i> Login</Link>
                                                </Col>
                                                <Col className="col-12">
                            ...
                            <div className="text-center pt-4">
                                <div className="font-weight-normal fs-16">You Don't have an account <Link className="btn-link font-weight-normal" to={`/account/register/register03`}>Register Here</Link></div>
                            </div>
                        </Col>
                    </Row>
                </div>
