                                ...
                                <Card className="p-4 page-content">
                                    <CardBody className="page-single-content">
                                        <div className="w-100">
                                            ...
                                            <p className="text-muted">Reset Password Page</p>
                                            ...
                                            <Row className="row">
                                                <Col className="col-12">
                                                    <Link role="button" to={`/dashboard/dashboard01`} className="btn  btn-lg btn-primary btn-block px-4"><i className="fe fe-arrow-right"></i> Reset</Link>
                                                </Col>
                                            </Row>
                                        </div>
                                    </CardBody>
...
ResetPassword03.propTypes = {};

ResetPassword03.defaultProps = {};
