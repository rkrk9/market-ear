                        ...
                        <Row className="justify-content-center" onClick={() => { switcherIconReomve() }}>
                            <Col md={7} lg={6} xl={5}>
                                ...
                                <div className="text-center pt-4">
                                    <div className="font-weight-normal fs-16">You Already have an account <Link className="btn-link font-weight-normal" to={`/account/login/login01`}>Login Here</Link></div>
                                </div>
                            </Col>
                        </Row>
                    </div>
...
Register01.propTypes = {};

Register01.defaultProps = {};
