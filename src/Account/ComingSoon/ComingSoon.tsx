...
const ComingSoon = () => {
  ...
  return (
    <div>
      ...
      <div className="page relative" onClick={() => { switcherIconReomve() }}>
        <div className="page-content">
          <div className="container text-center">
            <div className="display-2 text-primary mb-5 font-weight-bold">
              Coming soon
            </div>
            <h1 className="h3  mb-3 font-weight-bold">
              Thank you for being stayed
            </h1>
            <p className="h5 font-weight-normal mb-4 leading-normal">
              You may have mistyped the address or the page may have moved.
            </p>
            <Row>
              <Col md={6} className="d-block mx-auto mb-4">
                <Row>
                  ...
                  <Col className="col-auto">
                    <div className="fs-18 font-weight-bold">60%</div>
                  </Col>
                </Row>
              </Col>
            </Row>
            <Row>
              <div className="progress-wrapper mb-5 col-md-6 d-block mx-auto">
            ...
            <div className="coming-footer border-top border-dark-transparent">
              <div className="d-block mx-auto">
                <p className="h5 mb-4 leading-normal">
                  ...
                  <Link href="#" className="input-group-text bg-white p-2 btn">
                    ...
                    >
                      ...
                      <path
                        ...
                        opacity=".3"
                      ></path>
                      <path d="M2.01 3L2 10l15 2-15 2 .01 7L23 12 2.01 3zM4 8.25V6.03l7.51 3.22-7.51-1zm.01 9.72v-2.22l7.51-1-7.51 3.22z"></path>
                    </svg>
                  </Link>
                </div>
              </div>
