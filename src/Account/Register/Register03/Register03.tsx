...
import logo from "../../../../assets/images/pattern/login.png";
			...
			<Row className=" justify-content-center mt-7 mt-sm-0" onClick={() => { switcherIconReomve() }}>
				<Col xxl={8} lg={9}>
					<div className="card-group mb-0" >
							...
							<CardBody className=" page-single-content">
								...
								<div className="mb-3">
									<Label className="custom-control custom-checkbox">
										...
										<span className="custom-control-label">Agree the <Link href={`/pages/terms`} className="btn-link">terms and policy</Link></span>
									</Label>
								</div>
								<Row className="row">
									<Col className="col-12">
										<Link role="button" to={`/dashboard/dashboard01`} className="btn btn-lg btn-primary btn-block px-4"><i className="fe fe-arrow-right"></i> Create a new account</Link>
									</Col>
						...
						<Card className=" text-white bg-primary py-5 d-none d-lg-block page-content mt-0">
							<CardBody className=" text-center justify-content-center page-single-content">
								<img src={logo} alt="img"/>
							</CardBody>
						</Card>
					</div>
					<div className="text-center pt-4">
						<div className="font-weight-normal fs-16">You Already have an account <Link className="btn-link font-weight-normal" to={`/account/login/login03`}>Login Here</Link></div>
					</div>
				</Col>
			</Row>
		</div>
...
Register03.propTypes = {};

Register03.defaultProps = {};
