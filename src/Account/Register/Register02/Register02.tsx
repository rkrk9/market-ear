...
import { CardBody, Col, Input, InputGroup, Label, Row } from 'reactstrap';
import { Link } from 'react-router-dom';


const Register02 = () => {
	document.querySelector("body")?.classList.add("main-body", "light-mode", "ltr", "page-style2", "page-style1", "error-page");
							...
							<CardBody className="p-6">
								<Row>
									<Col md={8} className=" mx-auto d-block">
										...
										<div className="pt-4">
											<div className="font-weight-normal fs-16">You Already have an account <Link className="btn-link font-weight-normal" to={`/account/login/login02`}>Login Here</Link></div>
										</div>
									</Col>
								</Row>
							</CardBody>
...
Register02.propTypes = {};

Register02.defaultProps = {};
