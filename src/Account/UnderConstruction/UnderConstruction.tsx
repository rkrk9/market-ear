...
import { CardBody, Col, Input, InputGroup, Row } from 'reactstrap';
...
const UnderConstruction: FC<underconstructionprops> = () =>  {
  ...
  const switcherIconReomve = () => {
    ...
    let demo_changer1 = document.querySelector(".demo_changer") as HTMLInputElement
            ...
            <div className="w-40 bg-style h-100vh page-style">
                <div className="page-content">
                    <div className="page-single-content">
                        ...
                        <CardBody className=" text-white py-5 px-8">
                    ...
                    <CardBody className="p-6">
                        <Row className="row">
                            <Col lg={8}sm={12}  className="center-block align-items-center construction  ">
                                <div className="construction-body text-center">
                                    <CardBody className=" ">
                                        <h2 className="display-5 mb-2 font-weight-bold"><strong>Under Construction</strong></h2>
