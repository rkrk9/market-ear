	...
	<div className="page" onClick={() => { switcherIconReomve() }}>
		<div className="page-content">
			<div className="container text-center">
				<div className="display-1 text-primary mb-5 font-weight-bold dir-initial"> 5<i className="fa fa-frown-o"></i>3</div>
				<h1 className="h3  mb-3 font-weight-bold">Sorry, an error has occured, Server Unavailable </h1>
