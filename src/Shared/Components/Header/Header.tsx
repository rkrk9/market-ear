...
import Image from "../../../assets/images/users/16.jpg";
...
// FullScreen
var elem = document.documentElement as FullScreenEnabledElement;
...
const Fullscreen: any = (vale: any) => {
  ...
  const Darkmode = () => {
    if(document.querySelector(".app")?.classList.contains('dark-mode')){
      ...
      let DarkMenu1 = document.querySelector("#myonoffswitch1") as HTMLInputElement;
  ...
  //Header search 
  let myfunction = (inputvalue:string) => {
    if(document.querySelector(".search-result") != null){
      document.querySelector(".search-result")?.classList.remove("d-none");
    }

    let i: Object[] | any = [];
    let allElement2: Object[] | any = [];
  ...
  return (
    <Fragment>
      <Navbar className="app-header header top-header">
        <div className="container-fluid main-container">
          <div className="d-flex">
            <div className="dropdown side-nav">
              <div className="app-sidebar__toggle">
                <Link className="open-toggle" to="#" onClick={()=>{
                ...
                <Link className="close-toggle" to="#" onClick={()=>{
            ...
            <UncontrolledDropdown className="dropdown  header-option">
              <DropdownToggle
                tag="button"
              ...
              >
                ...
                <span className="nav-span">
                  Projects <i className="fa fa-angle-down ms-1 fs-18"></i>
                </span>
              </DropdownToggle>
            ...
            <div className="d-flex order-lg-2 ms-lg-auto">
              ...
              <div className="navbar navbar-expand-lg navbar-nav-right responsive-navbar navbar-dark p-0">
                ...
                >
                  <div className="d-flex" >
                    ...
                    {}
                    <div className="dropdown header-theme">
                      <Link
                        to="#"
                    ...
                    <UncontrolledDropdown className="dropdown header-notify">
                      <DropdownToggle
                    ...
                    <UncontrolledDropdown className="dropdown profile-dropdown">
                      <DropdownToggle
                        color=""
                      ...
                      <DropdownMenu className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        <div className="text-center">
                          ...
                          >
                             {outPut.firstName == undefined ? "John" : outPut.firstName} {outPut.lastName == undefined ? "Thomson" : outPut.lastName}
                          </DropdownItem>
                          <span className="text-center user-semi-title">
                          {outPut.role == undefined ? "App Developer" : outPut.role}
                          </span>
                          <div className="dropdown-divider"></div>
                        </div>
                        <DropdownItem
                          className="dropdown-item d-flex"
                          href={`/pages/profile/profile01/`}
                        >
                          <svg
              ...
              <div className="d-flex">
                <Link
                  to="#"
                  className="demo-icon new nav-link p-0 m-2"
                  onClick={() => swichermainright()}
                >
                  <svg
                    className="header-icon fa-spin" 
                    x="1008"
                    y="1248"
                    viewBox="0 0 24 24"
                    height="24"
