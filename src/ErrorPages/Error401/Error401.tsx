...
const Error401 = () => { 
	document.querySelector("body")?.classList.add("main-body", "light-mode", "ltr", "bg-style", "error-page");
	document.querySelector("body")?.classList.remove("side-shadow", "sidebar-mini");
  ...
  <div>
	...
	<div className="page" onClick={() => { switcherIconReomve() }}>
		<div className="page-content">
			<div className="container text-center  relative">
				<div className="display-1 text-white mb-5 font-weight-bold">401</div>
				<h1 className="h3  mb-3 font-weight-bold text-white">Un Authorized Error!</h1>
				<p className="h5 font-weight-normal mb-7 leading-normal text-white-80">You may have mistyped the address or the page may have moved.</p>
				<Link className="btn btn-secondary" to={`/dashboard/dashboard01`}><i className="fe fe-arrow-left-circle m-1"></i>Back to Home</Link>
			</div>
		</div>
	</div>
  </div>
