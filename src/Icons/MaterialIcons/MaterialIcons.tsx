...
const MaterialIcons = () => (
  <div>
    <PageHeaders
      ...
      home="Home"
      name="Icons"
      fonticonsname="Material Icons"
    />
    <Row>
      <Col md="12">
        <Card>
          <CardHeader>
            <CardTitle tag="h3">Material Filled Icons</CardTitle>
          </CardHeader>
          <CardBody>
            <Row>
              <Col sm="12" lg="12">
              ...
              <Col className="mb-4" lg="12" sm="12">
                <p className="mb-0 mt-5">
                  Simply beautiful open source icons. For more Icons{" "}
                  <a
        ...
        <Card>
          <CardHeader>
            <CardTitle tag="h3">Material Outlined Icons</CardTitle>
          </CardHeader>
          <CardBody>
            <Row>
              <Col sm="12" lg="12">
        ...
        <Card>
          <CardHeader>
            <CardTitle tag="h3">Material Two Toned Icons</CardTitle>
          </CardHeader>
          <CardBody>
            <Row>
              <Col sm="12" lg="12">
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        ...
                        <path
                          ...
                          opacity=".3"
                        />
                        <path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H5.17l-.59.59-.58.58V4h16v12zM11 5h2v6h-2zm0 8h2v2h-2z" />
                      </svg>
                    </li>
                    <li className="icons-list-item">
                      <svg
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        ...
                        <path
                          ...
                          opacity=".3"
                        />
                        <path d="M11 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0-6c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm-1 12H5c.2-.63 2.55-1.67 4.93-1.94h.03l.46-.45L12 14.06c-.39-.04-.68-.06-1-.06-2.67 0-8 1.34-8 4v2h9l-2-2zm10.6-5.5l-5.13 5.17-2.07-2.08L12 17l3.47 3.5L22 13.91z" />
                      </svg>
                    </li>
                    <li className="icons-list-item">
                      <svg
