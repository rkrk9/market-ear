...
import png from "../../../../assets/images/png/3.png"
					...
					<div className="w-40 bg-style h-100vh page-style">
						<div className="page-content">
							<div className="page-single-content">
								...
								<CardBody className="card-body text-white py-5 px-8 text-center">
									<img src={png} alt="img" className="w-100 mx-auto text-center" />
								</CardBody>
							</div>
						</div>
					</div>
					<div className="w-80 page-content" onClick={() => { switcherIconReomve() }}>
						<div className="page-single-content">
							<CardBody className=" p-6">
								<Row>
									<Col md={8} className="mx-auto d-block">
										...
										<div className="pt-4">
											<div className="font-weight-normal fs-16">You Don't have an account <Link className="btn-link font-weight-normal" to={`/account/register/register02`}>Register Here</Link></div>
										</div>
									</Col>
								</Row>
							</CardBody>
